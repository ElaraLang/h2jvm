...
;
    autodocodec = {
  meta = {
    sha256 = "1vsxcb4vnjq180c264gvz3jxsbb1mdf2gzwkfh08ap29lz47wkxh";
    url = "https://hackage.haskell.org";
    ver = "0.6.0.0";
  };
...
mkDerivation {
  pname = "autodocodec";
  version = "0.6.0.0";
  src = /nix/store/ij26xxdbns8hm0f98srpq6044m9lgvw3-source;
  libraryHaskellDepends = [
...
;
    autodocodec-nix = {
  meta = {
    sha256 = "0xhih99mlqc2gj1b2zn58mdflx3dgc0a5248z5qs26jrjgq90mkk";
    url = "https://hackage.haskell.org";
    ver = "0.1.0.2";
  };
...
mkDerivation {
  ...
  version = "0.1.0.2";
  src = /nix/store/7vf4n8j2h7b006fg6ihf6sp86cdjrn88-source;
  libraryHaskellDepends = [
...
;
    autodocodec-schema = {
  meta = {
    sha256 = "0jripbj5zs7vq4ya7qyzz6zxa55vq2c974ki7y2njqb19dz6lyl6";
    url = "https://hackage.haskell.org";
    ver = "0.2.0.2";
  };
...
mkDerivation {
  ...
  version = "0.2.0.2";
  src = /nix/store/78rjwf7543m8xa4hbhqlndw4g5fpsd56-source;
  libraryHaskellDepends = [
...
;
    autodocodec-yaml = {
  meta = {
    sha256 = "07x0y0ipfwkcjz12kflsbj84rnps24g2050qcdv1n59x0apaij5q";
    url = "https://hackage.haskell.org";
    ver = "0.4.0.3";
  };
...
mkDerivation {
  ...
  version = "0.4.0.3";
  src = /nix/store/n351nl2fjxy8r8nsqzkid5a6yfzv51qd-source;
  libraryHaskellDepends = [
...
;
    fast-myers-diff = {
  meta = {
    sha256 = "1f2d6s9smb6vsz3w0rar51hspwh4gr9vi2gagdsyfyfz71sdv8yz";
    url = "https://hackage.haskell.org";
    ver = "0.0.2";
  };
...
mkDerivation {
  ...
  version = "0.0.2";
  src = /nix/store/k5c8gria2gpp5wvwxs8y0gjm27d6mkga-source;
...
;
    safe-coloured-text = {
  meta = {
    sha256 = "17a4d5gly0s5rf1sqj3vrggwmkby8zpb9f5b7v9kyij9lxdk23ww";
    url = "https://hackage.haskell.org";
    ver = "0.6.0.0";
  };
...
mkDerivation {
  ...
  version = "0.6.0.0";
  src = /nix/store/65xczlz9qldg1ww52p46jf4mbjqv2jnl-source;
  libraryHaskellDepends = [
...
;
  ...
  meta = {
    sha256 = "0pand3kg4bj6r6s70c8wk1i5r48d1w9ivl7b150nns68km85kqx7";
    url = "https://hackage.haskell.org";
    ver = "0.2.0.2";
  };
...
mkDerivation {
  ...
  version = "0.2.0.2";
  src = /nix/store/qma4lxx1zajy05hl0kfk1flhxzg247i0-source;
...
;
    sydtest = {
  meta = {
    sha256 = "1l9kcy748qnimps25cbgpwgva3m9j7rby63ywa93j7awpdjvk1hp";
    url = "https://hackage.haskell.org";
    ver = "0.30.0.0";
  };
...
mkDerivation {
  pname = "sydtest";
  version = "0.30.0.0";
  src = /nix/store/6wb0bnlqjjf6l95q1yzpn0wwyhg2qbf7-source;
  libraryHaskellDepends = [
...
;
    wl-pprint-annotated = {
  meta = {
    sha256 = "14maxnl3njg2i7pyjmsynn3pwmri4rpvhwhxpcf99rbq2xki7h63";
    url = "https://hackage.haskell.org";
    ver = "0.1.0.2";
  };
...
mkDerivation {
  ...
  version = "0.1.0.2";
  src = /nix/store/jlxk8alq04bh8x8n2f2z285sdcmnq7mw-source;
