...
putInstruction = \case
    ...
    ALoad -> putWord8 MagicNumbers.instruction_aLoad
    ...
    AStore -> putWord8 MagicNumbers.instruction_aStore
    ...
    LDC index -> putWord8 MagicNumbers.instruction_ldc *> putWord16be index
